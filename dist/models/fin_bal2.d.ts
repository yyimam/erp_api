...
export declare type fin_bal2Pk = "idno";
export declare type fin_bal2Id = fin_bal2[fin_bal2Pk];
export declare type fin_bal2OptionalAttributes = "sno" | "descrip" | "note_no" | "fin_acode" | "ac_acode" | "calc1" | "calc2" | "lines" | "sysdate";
export declare type fin_bal2CreationAttributes = Optional<fin_bal2Attributes, fin_bal2OptionalAttributes>;
export declare class fin_bal2 extends Model<fin_bal2Attributes, fin_bal2CreationAttributes> implements fin_bal2Attributes {
    idno: number;
    sno?: number;
    descrip?: string;
    note_no?: number;
