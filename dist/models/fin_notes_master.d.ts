...
export declare type fin_notes_masterPk = "idno";
export declare type fin_notes_masterId = fin_notes_master[fin_notes_masterPk];
export declare type fin_notes_masterOptionalAttributes = "notedate" | "sysdate";
export declare type fin_notes_masterCreationAttributes = Optional<fin_notes_masterAttributes, fin_notes_masterOptionalAttributes>;
export declare class fin_notes_master extends Model<fin_notes_masterAttributes, fin_notes_masterCreationAttributes> implements fin_notes_masterAttributes {
    idno: number;
    note_no: number;
    notedate?: Date;
    sysdate?: Date;
