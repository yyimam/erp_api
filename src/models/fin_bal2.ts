...
export interface fin_bal2Attributes {
  idno: number;
  sno?: number;
  descrip?: string;
  note_no?: number;
...
export type fin_bal2Pk = "idno";
export type fin_bal2Id = fin_bal2[fin_bal2Pk];
export type fin_bal2OptionalAttributes = "sno" | "descrip" | "note_no" | "fin_acode" | "ac_acode" | "calc1" | "calc2" | "lines" | "sysdate";
export type fin_bal2CreationAttributes = Optional<fin_bal2Attributes, fin_bal2OptionalAttributes>;

export class fin_bal2 extends Model<fin_bal2Attributes, fin_bal2CreationAttributes> implements fin_bal2Attributes {
  idno!: number;
  sno?: number;
  descrip?: string;
  note_no?: number;
  ...
  // fin_bal2 belongsTo ac via ac_acode
  ac_acode_ac!: ac;
  ...
  // fin_bal2 belongsTo fin_ac via fin_acode
  ...
  // fin_bal2 belongsTo fin_notes_master via note_no
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof fin_bal2 {
