...
import { GoodsReturnToSupplierController } from './goodsReturnToSupplier.controllers';
...
@Module({
  ...
  controllers: [GoodsReturnToSupplierController],
  providers: [GoodsReturnToSupplierService],
})

export class GoodsReturnToSupplierModule {}