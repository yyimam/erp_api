...
import { FinishedGoodsProductionController } from './finishedGoodsProduction.controllers';
...
@Module({
  ...
  controllers: [FinishedGoodsProductionController],
  providers: [FinishedGoodsProductionService],
})

export class FinishedGoodsProductionModule {}