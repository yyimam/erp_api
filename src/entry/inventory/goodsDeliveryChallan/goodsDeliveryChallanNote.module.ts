...
import { GoodsDeliveryChallanController } from './goodsDeliveryChallan.controllers';
...
@Module({
  ...
  controllers: [GoodsDeliveryChallanController],
  providers: [GoodsDeliveryChallanService],
})

export class GoodsDeliveryChallanModule {}